...
WITH source_data AS (
 ...
 "DRC/FRC RECEIVED DATE":: VARCHAR(200) AS PRESALE_RC_RECEIVED_DATE,
 "COST ":: VARCHAR(100) AS RC_APPLICATION_COST,
 "BUYER DOCS STATUS":: VARCHAR(200) AS POSTSALE_BUYER_KYC,
 "SOLD DOCS RECEIVED DATE":: VARCHAR(200) AS Sold_Docs_Received_Date,
 ...
 "ORC APPLIED DATE":: VARCHAR(200) AS POSTSALE_DOCS_APPLIED_DATE,
 "SUBMITTED TO":: VARCHAR(100) AS POSTSALE_DOCS_SUBMITTED_TO,
 "ORC RECEIVED DATE":: VARCHAR(50) AS POSTSALE_DOCS_RECEIVED_DATE,
 "COST SPENT":: VARCHAR(50) AS POSTSALE_DOCUMENTATION_COST,
 NULL AS FILES
 FROM LIVE_RAW_DATA.DOCUMENTATION
